...
export default function MemoryPage() {
  ...
  const memPaths = [
    { label: 'Sona memory store', path: '/home/beniben/sona-workspace/.sona-brain.json' },
    { label: 'Voice config', path: '/home/beniben/sona-workspace/.sona-voice.json' },
    { label: 'Long-term memory (vector)', path: '/home/beniben/sona-workspace/memory/' },
  ...
  return (
    <PageShell>
      ...
      <div style={{
        ...
        <div>
          <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#f1f5f9', margin: 0, lineHeight: 1.2 }}>Memory</h1>
      ...
      <div style={{ flex: 1, padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div className="glass" style={{ borderRadius: '16px', padding: '20px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '16px', lineHeight: 1.6 }}>
            Memory files are managed server-side. They are not directly editable from this dashboard.
          </p>
