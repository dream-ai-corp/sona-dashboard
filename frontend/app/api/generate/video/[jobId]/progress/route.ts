...
/* ─── SSE proxy: streams video job progress from the backend ─────────────────
 * GET /api/generate/video/[jobId]/progress
...
export async function GET(
  ...
  try {
    backendRes = await fetch(`${BACKEND}/api/generate/video/${jobId}/progress`, {
